...
<body>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <!-- Cart Area -->
                <div class="cart-area">
                    <a href="#" id="essenceCartBtn"><img src="{{asset('user/img/core-img/bag.svg')}}" alt=""> <span>3</span></a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(user/img/bg-img/bg-2.jpg);">
                ...
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(user/img/bg-img/bg-3.jpg);">
                        <div class="catagory-content">
                            <a href="#">Shoes</a>
                        </div>
                    </div>
                ...
                <!-- Single Catagory -->
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="single_catagory_area d-flex align-items-center justify-content-center bg-img" style="background-image: url(user/img/bg-img/bg-4.jpg);">
                        <div class="catagory-content">
    ...
    <div class="cta-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="cta-content bg-img background-overlay" style="background-image: url(user/img/bg-img/bg-5.jpg);">
                    ...
                    <div class="popular-products-slides owl-carousel">
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{asset('user/img/product-img/product-3.jpg')}}" alt="">
                                <!-- Favourite -->
                                <div class="product-favourite">
                                    <a href="#" class="favme fa fa-heart"></a>
                                </div>
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{asset('user/img/product-img/product-4.jpg')}}" alt="">
                        ...
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{asset('user/img/product-img/product-5.jpg')}}" alt="">
                ...
                <div class="col-12 col-md-6">
                    <div class="single_widget_area d-flex mb-30">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="#"><img src="{{asset('user/img/core-img/logo2.png')}}" alt=""></a>
                        </div>
                        <!-- Footer Menu -->
